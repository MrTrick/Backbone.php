  ...
  return Backbone.View.extend({
    ...
    initialize: function(options) { 
      ...
      this.schema = (function() {
        ...
        if (model) {
        	model_schema = _.isFunction(model.schema) ? model.schema() : model.schema;
        	if (model_schema) return model_schema;
        }
        //Defined by class
        if (this.schema) return this.schema;
        
        throw new Error('Could not find schema in options, model or class definition');        
      }).call(this);
